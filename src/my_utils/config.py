...
HOME_DIR = Path(r"D:\Projects\Waveform\Code\AlternativeRubenCode\waveform_feature_estimation\OutputFolder\data")
...
CHECKPOINT_FILE = Path(r"D:\Projects\Waveform\AlternativeRubenCode\thesis-RhythmNet\OutputFolder\model_checkpoints.csv")
RESULTS_FILE = Path(r"D:\Projects\Waveform\AlternativeRubenCode\thesis-RhythmNet\OutputFolder\results.txt")

# Original data
PURE_TRACES_PATH = Path("/tudelft.net/staff-umbrella/StudentsCVlab/jjmkok/PixelTraces/")
VIPL_TRACES_PATH = Path("/tudelft.net/staff-umbrella/StudentsCVlab/jjmkok/VIPL_traces/")
VICAR_TRACES_PATH = Path("/tudelft.net/staff-bulk/ewi/insy/VisionLab/mbittner/VicarPPGBeyond/SkinpixelFiles/FaceReader9beta2Mask/")
FACE_DATA_DIR = HOME_DIR.parent / "VIPL-HR - original/data"
