...
class Normalization(object):
    ...
    SIGNAL_MINMAX_DICT = {
        'vicar': {'min':-0.010690713913484912,'max':0.010692317669192727},
        'vipl': {'min':-0.02000831843840957,'max':0.020034535165315108},
        'pure': {'min':-0.008302600494794084,'max':0.008294320580407612},
        'ubfc1': {'min':-0.008204783641165022,'max':0.008165112524001436},
        'ubfc2': {'min':-0.006324277996026313,'max':0.0063079112285916},
    }
...
IBIS_BOUNDS_DICT = {'pure': (-0.013251120739172135, 0.013155668534225732), 'ucla': (-0.09364932835540923, 0.0936350839587149), 'vicar': (-0.011044492422919243, 0.011047956239086056)}
